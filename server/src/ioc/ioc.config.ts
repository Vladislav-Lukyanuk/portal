...
import { UserWordPoolRepository } from "@app/db/repository/userWordPool/userWordPoolRepository";
...
container
  .bind<IUserWordPoolRepository>(DECLARATIONS.UserWordPoolRepository)
  .to(UserWordPoolRepository);
